...
function Index({}: Props) {
  ...
  return (
    <>
      <section className="section_inicio min-h-fit pt-[90px] h-[calc(100vh-90px)] relative w-full flex justify-center items-center flex-col max-md:bg-[url('/public/formacionV.jpeg')] md:bg-[url('/public/formacionH.jpeg')] bg-cover bg-center bg-fixed">
      ...
      <section className="section_tienda min-h-fit py-[90px]">
        <div className="w-full h-fit pb-5 flex justify-center text-5xl items-center text-primary">
          <img src="/public/florDeLis.svg" className="h-[48px]" />
        </div>
